...
We emphasize that the simulator consumes 
only $\beta$ and its own internally generated state. 
It does not consume any trace-derived timing information, phase durations, 
or other artifacts created during the estimation of $\beta$.
